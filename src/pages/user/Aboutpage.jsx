      ...
      <div className="w-[70%] mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-start mb-16">
          ...
          <div className="w-full md:w-1/2 md:pl-8">
            ...
            <p className="text-xl leading-8 mb-4">
              <span className="font-bold">Bus and Flight Tickets:</span> Whether
              you're traveling by air or by road, TravelTrax offers a
            ...
            <p className="text-xl leading-8">
              ...
              other services to enhance your travel experience. From car rentals
              and travel insurance to guided tours and event tickets, TravelTrax
              has you covered.
            </p>
          </div>
        </div>
