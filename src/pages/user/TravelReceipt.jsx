  ...
  return (
    <>
      <div className="w-[50%] mx-auto">
        ...
        >
          <div name="status" className="m-5 mb-20 text-md font-semibold">
            <p>Booking Status</p>
            <hr className="my-5 h-px bg-black" />
            <p>
              The reservation has been confirmed and the ticket number for this
              itinerary has been emailed. Thank you for booking with TravelTrax.
            </p>
          </div>
          <div name="customer_info" className="m-5 mb-20 text-md font-semibold">
          ...
          <div name="summary" className="m-5 mb-20 text-md font-semibold">
            <p>Trip Summary</p>
            <hr className="my-5 h-px bg-black" />
            <p>
